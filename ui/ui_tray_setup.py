...
from baligh.ui.ui_constants import ICON_PATH
...
def setup_tray(window):
    ...
    """
    window.tray_icon = QSystemTrayIcon(QIcon(ICON_PATH), window)
    tray_menu = QMenu()

    # ---------------- Language Selection Submenu ----------------
    language_menu = QMenu("Select Language", tray_menu)
    ...
    # ---------------- Toggle Clipboard ----------------
    window.clipboard_toggle_action = QAction("Enable Clipboard Capture", tray_menu, checkable=True)
    ...
    # ---------------- Show / Hide / Exit ----------------
    show_action = QAction("Show Window", tray_menu)
    show_action.triggered.connect(window.show)
    tray_menu.addAction(show_action)

    hide_action = QAction("Hide Window", tray_menu)
